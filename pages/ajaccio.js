...
let labelEXT;
let viewport;
//var image = document.getElementById("returnView");


window.onload = () => {
    const api = new JitsiMeetExternalAPI("8x8.vc", {
      roomName: "vpaas-magic-cookie-c054920adebc4d9fa89ad03cf8f5bffc/KleeClientFreeAjaccio",
...
async function InitApp() {
    await SDK3DVerse.joinOrStartSession({
        ...
        sceneUUID: "f33b24b4-050d-431a-a39e-7d79e04a9c87",
    ...
    viewport = SDK3DVerse.engineAPI.cameraAPI.getActiveViewports()[0];
